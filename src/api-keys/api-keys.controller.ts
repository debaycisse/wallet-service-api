...
import { CreateApiKeySwagger, RolloverApiKeySwagger } from '../common/decorators/swagger/api-keys.swagger';
...
export class ApiKeysController {
  ...
  @CreateApiKeySwagger()
  async createApiKey(@Req() req, @Body() createDto: CreateApiKeyDto) {
